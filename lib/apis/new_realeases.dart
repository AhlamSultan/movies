...
NewRealeases copyWith({  Dates? dates,
  ...
  num? totalPages,
  num? totalResults,
}) => NewRealeases(  dates: dates ?? this.dates,
  page: page ?? this.page,
